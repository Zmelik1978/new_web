 ...
 var files_topography = [
	...
	{'path': 'maps/topografie/santa-lucia.svg', 'name': '<span style="font-size: 14px; margin-left: 4px;">Santa Lucia (1921)</span>'},
];
...
var files_density = [
	...
	{'path': 'maps/density/santa-lucia-denzity.svg', 'name': '<span style="font-size: 14px; margin-left: 4px;">Santa Lucia (1921)</span>'},
];
...
var files_movement = [
    ...
    // {'path':'adresa obrázku', 'name': 'název jak se zobrazí u checkboxu'} 
    {'path': 'maps/topografie/podkladova_mapa.png', 'name': '<strong style="color:#696969; margin-left: 4px;">basic map</strong>'},
	{'path': 'maps/movement/santa-lucia-sit.svg', 'name': '<span style="font-size: 14px; margin-left: 4px;">Santa Lucia (1921)</span>'},
];
