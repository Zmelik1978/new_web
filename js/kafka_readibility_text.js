...
Highcharts.chart('flesh_reding_easy', {
    ...
    series: [{
        ...
        data: [
            // x, y, name values
            {x: 74542, y: 30.9116, name: removeTxtExtension ('Franz Kafka - Proces.txt')},
...
Highcharts.chart('flesh_kincaid_grade_level', {
    ...
    series: [{
        ...
        data: [
            {x: 74542, y: 15.6307, name: removeTxtExtension ('Franz Kafka - Proces.txt')},
        ],
        dataLabels: {
            enabled: true,
            format: '{point.name}'
...
Highcharts.chart('gunning_fox_index', {
    ...
    series: [{
        ...
        color: 'rgb(124,252,0)',
        data: [
            {x: 74542, y: 18.8046, name: removeTxtExtension ('Franz Kafka - Proces.txt')},
        ],
        dataLabels: {
            enabled: true,
            format: '{point.name}'
