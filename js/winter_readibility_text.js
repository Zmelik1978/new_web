...
Highcharts.chart('flesh_reding_easy', {
    ...
    series: [{
        ...
        data: [
            // x, y, name values
            {x: 169704, y: 29.8531, name: removeTxtExtension ('Zikmund Winter - Mistr Kampanus.txt')},
...
Highcharts.chart('flesh_kincaid_grade_level', {
    ...
    series: [{
        ...
        data: [
            {x: 169704, y: 14.5678, name: removeTxtExtension ('Zikmund Winter - Mistr Kampanus.txt')},
        ],
        dataLabels: {
            enabled: true,
            format: '{point.name}'
...
Highcharts.chart('gunning_fox_index', {
    ...
    series: [{
        ...
        color: 'rgb(124,252,0)',
        data: [
            {x: 169704, y: 18.1296, name: removeTxtExtension ('Zikmund Winter - Mistr Kampanus.txt')},
        ],
        dataLabels: {
            enabled: true,
            format: '{point.name}'
