...
Highcharts.chart('flesh_reding_easy', {
    ...
    series: [{
        ...
        data: [
            // x, y, name values
            {x: 27684, y: 34.5448, name: removeTxtExtension ('Petr Stančík - Pérák.txt')}, {x: 78607, y: 22.8282, name: removeTxtExtension ('Petr Stančík - Mlýn na mumie.txt')},
...
Highcharts.chart('flesh_kincaid_grade_level', {
    ...
    series: [{
        ...
        data: [
            {x: 27684, y: 12.3178, name: removeTxtExtension ('Petr Stančík - Pérák.txt')}, {x: 78607, y: 15.0915, name: removeTxtExtension ('Petr Stančík - Mlýn na mumie.txt')},
        ],
        dataLabels: {
            enabled: true,
            format: '{point.name}'
...
Highcharts.chart('gunning_fox_index', {
    ...
    series: [{
        ...
        color: 'rgb(124,252,0)',
        data: [
            {x: 27684, y: 15.7957, name: removeTxtExtension ('Petr Stančík - Pérák.txt')}, {x: 78607, y: 19.0396, name: removeTxtExtension ('Petr Stančík - Mlýn na mumie.txt')},
        ],
        dataLabels: {
            enabled: true,
            format: '{point.name}'
