...
Highcharts.chart('container-sentence-lenght', {
    ...
    series: [
            {
            name: 'Pravý výlet pana Broučka', showInLegend: false,
            marker: { 'symbol': 'circle', fillColor: "rgba(255,0,0,0)", lineColor: "#0000FF", lineWidth: 2 },
            data: [[15.24, 0], [12.13, 1], [11.3, 2], [19.59, 4], [18.01, 6], [27.88, 11]]
            },
            {
            name: 'Nový epochální výlet pana Broučka', showInLegend: false,
            marker: { 'symbol': 'circle', fillColor: "rgba(255,0,0,0)", lineColor: "#0000FF", lineWidth: 2 },
            data: [[17.03, 0], [12.13, 1], [12.23, 2], [21.34, 6]]
            }
    ]
});
