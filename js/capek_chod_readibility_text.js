...
Highcharts.chart('flesh_reding_easy', {
    ...
    series: [{
        ...
        data: [
            // x, y, name values
            {x: 57084, y: 27.1944, name: removeTxtExtension ('Karel M. Čapek-Chod - Kašpar Lén mstitel.txt')},
...
Highcharts.chart('flesh_kincaid_grade_level', {
    ...
    series: [{
        ...
        data: [
            {x: 57084, y: 15.8427, name: removeTxtExtension ('Karel M. Čapek-Chod - Kašpar Lén mstitel.txt')},
        ],
        dataLabels: {
            enabled: true,
            format: '{point.name}'
...
Highcharts.chart('gunning_fox_index', {
    ...
    series: [{
        ...
        color: 'rgb(124,252,0)',
        data: [
            {x: 57084, y: 19.2719, name: removeTxtExtension ('Karel M. Čapek-Chod - Kašpar Lén mstitel.txt')},
        ],
        dataLabels: {
            enabled: true,
            format: '{point.name}'
