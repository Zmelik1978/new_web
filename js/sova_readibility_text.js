...
Highcharts.chart('flesh_reding_easy', {
    ...
    series: [{
        ...
        data: [
            // x, y, name values
            {x: 80887, y: 41.9425, name: removeTxtExtension ('Antonín Sova - Ivův román.txt')},
...
Highcharts.chart('flesh_kincaid_grade_level', {
    ...
    series: [{
        ...
        data: [
            {x: 80887, y: 11.3844, name: removeTxtExtension ('Antonín Sova - Ivův román.txt')},
        ],
        dataLabels: {
            enabled: true,
            format: '{point.name}'
...
Highcharts.chart('gunning_fox_index', {
    ...
    series: [{
        ...
        color: 'rgb(124,252,0)',
        data: [
            {x: 80887, y: 14.6254, name: removeTxtExtension ('Antonín Sova - Ivův román.txt')},
        ],
        dataLabels: {
            enabled: true,
            format: '{point.name}'
