...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/17_AJVAZ/konkordance.php">
...
<main>
  <div class="container py-4">   
    ...
    <div style="float: left; margin-left: 2rem; margin-top: -9rem; width: 100%;">

    <?php
        if(isset($_POST["submit"])) {
            if(!empty($_POST["druhemesto"])) {
              require "php/druhemesto_konkordance.php";
              
            }
            if(!empty($_POST["luxemburskazahrada"])) {
              require "php/luxemburskazahrada_konkordance.php";
             
            }
            if(!empty($_POST["vrazdavhoteluintercontinental"])) {
              require "php/vrazdavhoteluintercontinental_konkordance.php";
              
            }
            if(!empty($_POST["navratstarehovarana"])) {
              require "php/navratstarehovarana_konkordance.php";
