...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/17_AJVAZ/pozicnitagy.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      ...
      <div style="float: left; margin-top: 20px; width: 400px;">
            <?php
                require "php/druhemestocompletmorphotags.php";
                require "php/luxemburskazahradacompletmorphotags.php";
                require "php/vrazdavhoteluintercontinentalcompletmorphotags.php";
                require "php/navratstarehovaranacompletmorphotags.php";
            ?>
      </div>
    </div>
