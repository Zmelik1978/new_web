...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/17_AJVAZ/frekvence.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="frekvence.php" method="post" style="float: left; margin-right: 50px;">
        <input type="text" name="druhemesto" placeholder="Druhé město" style="margin-bottom: 5px; width: 250px;"><br>
        <input type="text" name="luxemburskazahrada" placeholder="Luxemburská zahrada" style="margin-bottom: 5px; width: 250px;"><br>
        <input type="text" name="vrazdavhoteluintercontinental" placeholder="Vražda v hotelu Intercontinental" style="margin-bottom: 7px; width: 250px;"><br>
        <input type="text" name="navratstarehovarana" placeholder="Návrat starého varana" style="margin-bottom: 7px; width: 250px;"><br>
        ...
        <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["druhemesto"])) {
              require "php/druhemesto_frekvence.php";
            }
            if(!empty($_POST["luxemburskazahrada"])) {
              require "php/luxemburskazahrada_frekvence.php";
            }
            if(!empty($_POST["vrazdavhoteluintercontinental"])) {
              require "php/vrazdavhoteluintercontinental_frekvence.php";
            }
            if(!empty($_POST["navratstarehovarana"])) {
              require "php/navratstarehovarana_frekvence.php";
            }
          }
        ?>
      </div>
