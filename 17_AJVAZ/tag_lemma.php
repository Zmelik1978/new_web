...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/17_AJVAZ/tag_lemma.php">
  ...
  <div class="container py-4">   
    ...
    <div style="width: 100%;"> 
        ...
        <form id = "dataForm" action="tag_lemma.php" method="post" style="float: left; height: 200px; margin-right: 30px; margin-top: 20px;">         
          ...
          <input type="text" name="druhemesto" placeholder="Druhé město" style="width: 250px; margin-bottom: 3px;"><br>
          <input type="text" name="luxemburskazahrada" placeholder="Luxemburská zahrada" style="width: 250px; margin-bottom: 3px;"><br>
          <input type="text" name="vrazdavhoteluintercontinental" placeholder="Vražda v hotelu Intercontinental" style="width: 250px; margin-bottom: 3px;"><br>
          <input type="text" name="navratstarehovarana" placeholder="Návrat starého varana" style="width: 250px; margin-bottom: 3px;"><br>
      ...
      <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["druhemesto"])) {
              require "php/druhemesto_slovnidruhy.php";
            }
            if(!empty($_POST["luxemburskazahrada"])) {
              require "php/luxemburskazahrada_slovnidruhy.php";
            }
            if(!empty($_POST["vrazdavhoteluintercontinental"])) {
              require "php/vrazdavhoteluintercontinental_slovnidruhy.php";
            }
            if(!empty($_POST["navratstarehovarana"])) {
              require "php/navratstarehovarana_slovnidruhy.php";
            }            
          }
        ?>
      </div>
