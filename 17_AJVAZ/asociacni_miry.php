...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/17_AJVAZ/asociacni_miry.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="asociacni_miry.php" method="post" style="float: left;">
        <input type="text" name="druhemesto" placeholder="Druhé město" style="margin-bottom: 7px; width: 250px;"><br>
        <input type="text" name="luxemburskazahrada" placeholder="Luxemburská zahrada" style="margin-bottom: 7px; width: 250px;"><br>
      ...
      <?php
          if(isset($_POST["Submit"])) {
            if(!empty($_POST["druhemesto"])) {
              require "php/druhemesto_kolokace.php";
          }
          if(!empty($_POST["luxemburskazahrada"])) {
            require "php/luxemburskazahrada_kolokace.php";
          }
          if(!empty($_POST["vrazdavhoteluintercontinental"])) {
            require "php/vrazdavhoteluintercontinental_kolokace.php";
          }
          if(!empty($_POST["navratstarehovarana"])) {
            require "php/navratstarehovarana_kolokace.php";
          }
        }
      ?>
    <div>
