...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <title>CQL Query</title>
    <link rel="canonical" href="https://korpusprozy.com/10_MRSTIK/cql.php">
  ...
  <div class="container py-4">   
    ...
    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
      <div class="container-fluid py-0">
        <h1 style="text-align: center; color: #d63384;">CQL Query</h1>
      </div>
    </div>

    <p id ="cql_query" class ="description"></p>
    <script src="../js/description_maps.js"></script>

    <!-- generátor CQL dotazů -->
    <input type="text" id="description" placeholder="E.g. verbs ending in ti" style="margin-bottom: 5px;"><br>
    <button onclick="generateQuery()">Generate Query</button>
    <pre id="queryContent"></pre>
    <div id="queryOutput" style="display: none;"></div>

    <script src="../js/cql_generator.js"></script>

    <!--FORMULÁŘ PRO ZADÁVÁANÍ LEMMAT-->
    <form action="cql.php" method="post" style="float: left; margin-top: 2rem;">
        <label name="pocetradku" style="font-size: 14px;">Number of rows: </label>
        <input type="number" name="limit" style="background-color: #ebdef0; margin-bottom: 5px; width: 50px;" value="50"><br>
        <input type="text" id="cqlQuery" name="cqlQuery" placeholder="CQL Query" style="margin-bottom: 7px;"><br>
    ...
    <div style="float: left; margin-left: 1rem;">
        ...
        <?php
        require "php/cql_all_mrstik.php";
        ?>
    </div>
