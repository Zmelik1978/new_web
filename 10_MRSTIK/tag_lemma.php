...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/10_MRSTIK/tag_lemma.php">
  ...
  <div class="container py-4">   
    ...
    <ul>
      ...
      <li class="dropdown">
        ...
        <div class="dropdown-content">
          ...
          <a href="words_in_context.php">Word in Context</a>
    ...
    <div style="width: 100%;"> 
        ...
        <form id = "dataForm" action="tag_lemma.php" method="post" style="float: left; height: 200px; margin-right: 30px; margin-top: 20px;">         
          ...
          <input type="text" name="santalucia" placeholder="Santa Lucia" style="width: 300px; margin-bottom: 3px;"><br>
      ...
      <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["santalucia"])) {
              require "php/santalucia_slovnidruhy.php";
            }            
          }
        ?>
      </div>
