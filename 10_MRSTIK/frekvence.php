...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/10_MRSTIK/frekvence.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="frekvence.php" method="post" style="float: left; margin-right: 50px;">
        <input type="text" name="santalucia" placeholder="Santa Lucuia" style="margin-bottom: 5px; width: 13rem;"><br>
        ...
        <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["santalucia"])) {
              require "php/santalucia_frekvence.php";
            }
          }
        ?>
      </div>
