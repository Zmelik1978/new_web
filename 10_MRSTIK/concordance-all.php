...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/10_MRSTIK/concordance-all.php">
  ...
  <div class="container py-4">   
    ...
    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
      <div class="container-fluid py-0">
        <h1 style="text-align: center; color: #d63384;">Concordance in all the author's texts</h1>
      </div>
    </div>

    <p id ="description_concordance_all" class ="description"></p>
    <script src="../js/description_maps.js"></script>

    <!--FORMULÁŘ PRO ZADÁVÁANÍ LEMMAT-->
    <form action="concordance-all.php" method="post" style="float: left;">
        <input type="text" name="concordance" placeholder="type lemma" style="margin-bottom: 7px;"><br>
    ...
    <?php
        if(isset($_POST["submit"])) {
            if(!empty($_POST["concordance"])) {
              require "php/concordance_all_mrstik.php";
          }
        }
    ?>
    </div>
