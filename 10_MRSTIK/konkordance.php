...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/10_MRSTIK/konkordance.php">
...
<main>
  <div class="container py-4">   
    ...
    <div style="float: left; margin-left: 2rem; margin-top: -3rem; width: 100%;">

    <?php
        if(isset($_POST["submit"])) {
            if(!empty($_POST["santalucia"])) {
              require "php/santalucia_konkordance.php";
