...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/10_MRSTIK/asociacni_miry.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="asociacni_miry.php" method="post" style="float: left;">
      <input type="text" name="santalucia" placeholder="Santa Lucia" style="margin-bottom: 7px;"><br>
      ...
      <?php
          if(isset($_POST["Submit"])) {
            if(!empty($_POST["santalucia"])) {
              require "php/santalucia_kolokace.php";
          }
        }
      ?>
    <div>
