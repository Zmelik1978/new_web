...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/16_KAFKA/tag_lemma.php">
  ...
  <div class="container py-4">   
    ...
    <div style="width: 100%;"> 
        ...
        <form id = "dataForm" action="tag_lemma.php" method="post" style="float: left; height: 200px; margin-right: 30px; margin-top: 20px;">         
          ...
          <input type="text" name="proces" placeholder="Proces" style="width: 300px; margin-bottom: 3px;"><br>
      ...
      <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["proces"])) {
              require "php/proces_slovnidruhy.php";
            }            
          }
        ?>
      </div>
