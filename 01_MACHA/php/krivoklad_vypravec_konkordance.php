...
if (isset($_POST["submit"])){
    if ($_POST["radio"] && $_POST["radio"] == "2"){
        if ($_POST["krivoklad"]){
            $lemma = $_POST["krivoklad"];
            $conection = mysqli_connect("127.0.0.1", "korpusprozyco001", "prasmoid", "korpusprozycom");
            mysqli_set_charset($conection, "utf8mb4");
            $sql = "SELECT id, token, title FROM krivokladnarratorkonkordance WHERE lemma='".$lemma."'";
            ...
            if (mysqli_num_rows($result_lemma) > 0){
                while ($radek_lemma = mysqli_fetch_assoc($result_lemma)){
                    ...
                    if ($ID_LEMMA) {
                        ...
                        $sql2 = "SELECT token FROM krivokladnarratorkonkordance WHERE id='".$tokenPlusJedna."'";
                        ...
                        $sql3 = "SELECT token FROM krivokladnarratorkonkordance WHERE id='".$tokenPlusDva."'";
                        ...
                        $sql4 = "SELECT token FROM krivokladnarratorkonkordance WHERE id='".$tokenPlusTri."'";
                        ...
                        $sql5 = "SELECT token FROM krivokladnarratorkonkordance WHERE id='".$tokenPlusCtyri."'";
                        ...
                        $sql6 = "SELECT token FROM krivokladnarratorkonkordance WHERE id='".$tokenPlusPet."'";
                        ...
                        $sql7 = "SELECT token FROM krivokladnarratorkonkordance WHERE id='".$tokenPMinusJedna."'";
                        ...
                        $sql8 = "SELECT token FROM krivokladnarratorkonkordance WHERE id='".$tokenPMinusDve."'";
                        ...
                        $sql9 = "SELECT token FROM krivokladnarratorkonkordance WHERE id='".$tokenPMinusTri."'";
                        ...
                        $sql10 = "SELECT token FROM krivokladnarratorkonkordance WHERE id='".$tokenPMinusCtyri."'";
                        ...
                        $sql11 = "SELECT token FROM krivokladnarratorkonkordance WHERE id='".$tokenPMinusPet."'";
