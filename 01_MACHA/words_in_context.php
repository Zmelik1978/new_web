...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/01_MACHA/words_in_context.php">
  ...
  <div class="container py-4">   
    ...
    <form action="words_in_context.php" method="post" style="margin-bottom: 7px;">
        <div style="float: left; margin-right: 20px;">
            <label style="font-size: 15px; color: blue; font-weight: 550;">first lemma: </label><br>
            <input type="text" name="word1" placeholder="" style="margin-bottom: 7px;">
        </div>
        <div style="float: left; margin-right: 20px;">
            <label style="font-size: 15px; color: blue; font-weight: 550;">second lemma: </label><br>
    ...
    <div style="float: left; margin-top: 100px; margin-left: -438px;">
        <?php
            require "php/macha_wordsincontext.php";
        ?>
    </div>
