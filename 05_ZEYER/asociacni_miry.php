...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/05_ZEYER/asociacni_miry.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="asociacni_miry.php" method="post" style="float: left;">
      <input type="text" name="janmariaplojhar" placeholder="Jan Maria Plojhar" style="margin-bottom: 7px;"><br>
      <input type="text" name="legendaprazska" placeholder="Legenda pražská" style="margin-bottom: 7px;"><br>
      <input type="text" name="legendatoledska" placeholder="Legenda toledská" style="margin-bottom: 7px;"><br>
      <input type="text" name="legendaslovenska" placeholder="Legenda slovenská" style="margin-bottom: 7px;"><br>
      ...
      <?php
          if(isset($_POST["Submit"])) {
            if(!empty($_POST["legendaprazska"])) {
              require "php/legendaprazska_kolokace.php";
            }
            if(!empty($_POST["legendatoledska"])) {
              require "php/legendatoledska_kolokace.php";
            }
            if(!empty($_POST["legendaslovenska"])) {
              require "php/legendaslovenska_kolokace.php";
            }
            if(!empty($_POST["janmariaplojhar"])) {
              require "php/janmariaplojhar_kolokace.php";
            }
          }
      ?>
    <div>
