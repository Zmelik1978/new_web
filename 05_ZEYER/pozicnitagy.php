...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/05_ZEYER/pozicnitagy.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      ...
      <div style="float: left; margin-top: 20px; width: 400px;">
        <?php
            require "php/janmariaplojharcompletmorphotags.php";
            require "php/legendaprazskacompletmorphotags.php";
            require "php/legendatoledskacompletmorphotags.php";
            require "php/legendaslovenskacompletmorphotags.php";
        ?>
      </div>
    </div>
