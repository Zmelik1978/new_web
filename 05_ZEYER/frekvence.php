...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/05_ZEYER/frekvence.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="frekvence.php" method="post" style="float: left; margin-right: 50px;">
        <input type="text" name="janmariaplojhar" placeholder="Jan Maria Plojhar" style="margin-bottom: 5px;"><br>
        <input type="text" name="legendaprazska" placeholder="Legenda pražská" style="margin-bottom: 5px;"><br>
        <input type="text" name="legendatoledska" placeholder="Legenda toledská" style="margin-bottom: 5px;"><br>
        <input type="text" name="legendaslovenska" placeholder="Legenda slovenská" style="margin-bottom: 5px;"><br>
        ...
        <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["legendaprazska"])) {
              require "php/legendaprazska_frekvence.php";
            }
          if(!empty($_POST["legendatoledska"])) {
            require "php/legendatoledska_frekvence.php";
          }
          if(!empty($_POST["legendaslovenska"])) {
            require "php/legendaslovenska_frekvence.php";
          }
          if(!empty($_POST["janmariaplojhar"])) {
            require "php/janmariaplojhar_frekvence.php";
          }
        }
        ?>
      </div>
