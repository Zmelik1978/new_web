  ...
  <div class="container py-4">   
    ...
    <div style="width: 100%;"> 
        ...
        <form id = "dataForm" action="tag_lemma.php" method="post" style="float: left; height: 200px; margin-right: 30px; margin-top: 20px;">         
          ...
          <input type="text" name="janmariaplojhar" placeholder="Jan Maria Plojhar" style="width: 300px; margin-bottom: 3px;"><br>
          <input type="text" name="legendaprazska" placeholder="Legenda pražská" style="width: 300px; margin-bottom: 3px;"><br>
          <input type="text" name="legendatoledska" placeholder="Legenda toledská" style="width: 300px; margin-bottom: 3px;"><br>
          <input type="text" name="legendaslovenska" placeholder="Legenda slovenská" style="width: 300px; margin-bottom: 3px;"><br>
        ...
        <?php
            if(isset($_POST["submit"])) {
              if(!empty($_POST["janmariaplojhar"])) {
                require "php/janmariaplojhar_slovnidruhy.php";
              }
            if(!empty($_POST["legendaprazska"])) {
              require "php/legendaprazska_slovnidruhy.php";
            }
            if(!empty($_POST["legendatoledska"])) {
              require "php/legendatoledska_slovnidruhy.php";         
            }
            if(!empty($_POST["legendaslovenska"])) {
              require "php/legendaslovenska_slovnidruhy.php";         
            }
          }
          ?>
      </div>
