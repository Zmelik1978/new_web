...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/05_ZEYER/konkordance.php">
    ...
    <?php
        if(isset($_POST["submit"])) {
            if(!empty($_POST["janmariaplojhar"])) {
              require "php/janmariaplojhar_konkordance.php";
              
            }
            if(!empty($_POST["legendaprazska"])) {
              require "php/legendaprazska_konkordance.php";
              
            }
            if(!empty($_POST["legendatoledska"])) {
              require "php/legendatoledska_konkordance.php";
              
            }
            if(!empty($_POST["legendaslovenska"])) {
              require "php/legendaslovenska_konkordance.php";
