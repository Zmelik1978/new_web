...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <title>Frequency of Lemmas</title>
    <link rel="canonical" href="https://korpusprozy.com/lemma_frequency_all_corpus.php">
  ...
  <div class="container py-4">   
    ...
    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
      <div class="container-fluid py-0">
        <h1 style="text-align: center; color: #d63384">Frequency of Lemmas</h1>
      </div>
    </div>
    
    <p id ="frequency_lemmas" class ="description"></p>
    <script src="../js/description_maps.js"></script>

    <div>
        <form action="lemma_frequency_all_corpus.php" method="post" style="float: left; margin-right: 50px;">
            <input type="text" name="lemma" placeholder="lemma" style="margin-bottom: 5px; width: 19rem;"><br>
    ...
    <div style="float: left;">
        <?php
            if(isset($_POST['submit'])) {
                $lemma != $_POST['lemma'];
                require "php/lemma_frequency.php";
            }
        ?>
    </div>
  </div>
