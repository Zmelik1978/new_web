...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/06_SVETLA/frekvence.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="frekvence.php" method="post" style="float: left; margin-right: 50px;">
        <input type="text" name="cernypetricek" placeholder="Černý Petříček" style="margin-bottom: 5px;"><br>
        <input type="text" name="zvoneckovakralovna" placeholder="Zvonečková královna" style="margin-bottom: 5px;"><br>
        <input type="text" name="prvniceska" placeholder="První Češka" style="margin-bottom: 5px;"><br>
        <input type="text" name="mladapanizapletalova" placeholder="Mladá paní Zapletalová" style="margin-bottom: 5px;"><br>
        <input type="text" name="skapulir" placeholder="Škapulíř" style="margin-bottom: 5px;"><br>
        <input type="text" name="nakosatkach" placeholder="Na košatkách" style="margin-bottom: 5px;"><br>
        ...
        <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["cernypetricek"])) {
              require "php/cernypetricek_frekvence.php";
            }
            if(!empty($_POST["zvoneckovakralovna"])) {
              require "php/zvoneckovakralovna_frekvence.php";
            }
            if(!empty($_POST["prvniceska"])) {
              require "php/prvniceska_frekvence.php";
            }
            if(!empty($_POST["mladapanizapletalova"])) {
              require "php/mladapanizapletalova_frekvence.php";
            }
            if(!empty($_POST["skapulir"])) {
              require "php/skapulir_frekvence.php";
            }
            if(!empty($_POST["nakosatkach"])) {
              require "php/nakosatkach_frekvence.php";
          }
        }
        ?>
      </div>
