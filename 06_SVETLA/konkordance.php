...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/06_SVETLA/konkordance.php">
...
<main>
  <div class="container py-4">   
    ...
    <div style="float: left; margin-left: 2rem; margin-top: -14rem; width: 100%;">

    <?php
        if(isset($_POST["submit"])) {
            if(!empty($_POST["cernypetricek"])) {
              require "php/cernypetricek_konkordance.php";
             
            }
            if(!empty($_POST["zvoneckovakralovna"])) {
              require "php/zvoneckovakralovna_konkordance.php";
              
            }
            if(!empty($_POST["prvniceska"])) {
              require "php/prvniceska_konkordance.php";
              
            }
            if(!empty($_POST["mladapanizapletalova"])) {
              require "php/mladapanizapletalova_konkordance.php";
             
            }
            if(!empty($_POST["skapulir"])) {
              require "php/skapulir_konkordance.php";
             
            }
            if(!empty($_POST["nakosatkach"])) {
              require "php/nakosatkach_konkordance.php";
