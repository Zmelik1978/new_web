...
if (isset($_POST["submit"])){
    if ($_POST["word1"] and $_POST["word2"]){
        ...
        $sql1 = "SELECT id FROM allsvetlakonkordance WHERE lemma='".$lemma1."'";
        $sql2 = "SELECT id FROM allsvetlakonkordance WHERE lemma='".$lemma2."'";
        ...
        foreach ( $ids1 as $id1 ) {
            ...
            if ( $c1 > 0  or $c1 < 0) {
                ...
                $sql_query_minus_2 = "SELECT token FROM allsvetlakonkordance WHERE id ='".($id1-2)."'";
                ...
                $sql_query_minus_3 = "SELECT token FROM allsvetlakonkordance WHERE id ='".($id1-3)."'";
                ...
                $sql_query_minus_4 = "SELECT token FROM allsvetlakonkordance WHERE id ='".($id1-4)."'";
                ...
                $sql_query_minus_5 = "SELECT token FROM allsvetlakonkordance WHERE id ='".($id1-5)."'";
