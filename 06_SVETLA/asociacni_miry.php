...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/06_SVETLA/asociacni_miry.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="asociacni_miry.php" method="post" style="float: left;">
      <input type="text" name="cernypetricek" placeholder="Černý Petříček" style="margin-bottom: 7px;"><br>
      <input type="text" name="zvoneckovakralovna" placeholder="Zvonečková královna" style="margin-bottom: 7px;"><br>
      <input type="text" name="prvniceska" placeholder="První Češka" style="margin-bottom: 7px;"><br>
      <input type="text" name="mladapanizapletalova" placeholder="Mladá paní Zapletalová" style="margin-bottom: 7px;"><br>
      <input type="text" name="skapulir" placeholder="Škapulíř" style="margin-bottom: 7px;"><br>
      <input type="text" name="nakosatkach" placeholder="Na košatkách" style="margin-bottom: 7px;"><br>
      ...
      <?php
          if(isset($_POST["Submit"])) {
            if(!empty($_POST["cernypetricek"])) {
              require "php/cernypetricek_kolokace.php";
          }
          if(!empty($_POST["zvoneckovakralovna"])) {
            require "php/zvoneckovakralovna_kolokace.php";
          }
          if(!empty($_POST["prvniceska"])) {
            require "php/prvniceska_kolokace.php";
          }
          if(!empty($_POST["mladapanizapletalova"])) {
            require "php/mladapanizapletalova_kolokace.php";
          }
          if(!empty($_POST["skapulir"])) {
            require "php/skapulir_kolokace.php";
          }
          if(!empty($_POST["nakosatkach"])) {
            require "php/nakosatkach_kolokace.php";
        }
      }
      ?>
    <div>
