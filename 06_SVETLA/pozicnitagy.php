...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/06_SVETLA/pozicnitagy.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="pozicnitagy.php" method="post" style="float: left; height: 100px; margin-right: 30px; margin-top: 20px;">
        <input type="text" name="cernypetricek" placeholder="Černý Petříček" style="width: 200px; margin-bottom: 3px;"><br>
        <input type="text" name="zvoneckovakralovna" placeholder="Zvonečková královnma" style="width: 200px; margin-bottom: 3px;"><br>
        <input type="text" name="prvniceska" placeholder="První Češka" style="width: 200px; margin-bottom: 3px;"><br>
        <input type="text" name="mladapanizapletalova" placeholder="Mladá paní Zapletalová" style="width: 200px; margin-bottom: 3px;"><br>
        <input type="text" name="skapulir" placeholder="Škapulíř" style="width: 200px; margin-bottom: 3px;"><br>
        <input type="text" name="nakosatkach" placeholder="Na košatkách" style="width: 200px; margin-bottom: 3px;"><br>
      ...
      <div style="float: left; margin-top: 20px; width: 400px;">
            <?php
                require "php/cernypetricekcompletmorphotags.php";
                require "php/zvoneckovakralovnacompletmorphotags.php";
                require "php/prvniceskacompletmorphotags.php";
                require "php/mladapanizapletalovacompletmorphotags.php";
                require "php/skapulircompletmorphotags.php";
                require "php/nakosatkachcompletmorphotags.php";
            ?>
      </div>
    </div>
