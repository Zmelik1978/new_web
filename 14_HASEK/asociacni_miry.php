...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/14_HASEK/asociacni_miry.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="asociacni_miry.php" method="post" style="float: left;">
      <input type="text" name="svejk1" placeholder="Osudy dobrého vojáka Švejka... I" style="margin-bottom: 7px; width: 15rem;"><br>
      <input type="text" name="svejk2" placeholder="Osudy dobrého vojáka Švejka... II" style="margin-bottom: 7px; width: 15rem;"> <br>
      ...
      <?php
          if(isset($_POST["Submit"])) {
            if(!empty($_POST["svejk1"])) {
              require "php/svejk1_kolokace.php";
          }
          if(!empty($_POST["svejk2"])) {
            require "php/svejk2_kolokace.php";
        }
      }
      ?>
    <div>
