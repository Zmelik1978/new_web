...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/14_HASEK/konkordance.php">
...
<main>
  <div class="container py-4">   
    ...
    <div style="float: left; margin-left: 2rem; margin-top: -4.5rem; width: 100%;">

    <?php
        if(isset($_POST["submit"])) {
            if(!empty($_POST["svejk1"])) {
              require "php/svejk1_konkordance.php";
              
            }
            if(!empty($_POST["svejk2"])) {
              require "php/svejk2_konkordance.php";
