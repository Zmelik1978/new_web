...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/14_HASEK/frekvence.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="frekvence.php" method="post" style="float: left; margin-right: 50px;">
        <input type="text" name="svejk1" placeholder="Osudy dobrého vojáka... I" style="margin-bottom: 5px; width: 15rem;"><br>
        <input type="text" name="svejk2" placeholder="Osudy dobrého vojáka... II" style="margin-bottom: 5px; width: 15rem;"><br> 
        ...
        <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["svejk1"])) {
              require "php/svejk1_frekvence.php";
            }
            if(!empty($_POST["svejk2"])) {
              require "php/svejk2_frekvence.php";
          }
        }
        ?>
      </div>
