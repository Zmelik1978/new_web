...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/14_HASEK/pozicnitagy.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="pozicnitagy.php" method="post" style="float: left; height: 100px; margin-right: 30px; margin-top: 20px;">
          <input type="text" name="svejk1" placeholder="Osudy dobrého vojáka Švejka... I" style="width: 19rem; margin-bottom: 3px;"><br>
          <input type="text" name="svejk2" placeholder="Osudy dobrého vojáka Švejka... II" style="width: 19rem; margin-bottom: 3px;"><br>
      ...
      <div style="float: left; margin-top: 20px; width: 400px;">
            <?php
                require "php/svejk1completmorphotags.php";
                require "php/svejk2completmorphotags.php";
            ?>
      </div>
    </div>
