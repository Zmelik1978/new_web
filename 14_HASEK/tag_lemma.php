...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/14_HASEK/tag_lemma.php">
  ...
  <div class="container py-4">   
    ...
    <div style="width: 100%;"> 
        ...
        <form id = "dataForm" action="tag_lemma.php" method="post" style="float: left; height: 200px; margin-right: 30px; margin-top: 20px;">         
          ...
          <input type="text" name="svejk1" placeholder="Osudy dobrého vojáka Švejka... I" style="width: 300px; margin-bottom: 3px; width: 15rem;"><br>
          <input type="text" name="svejk2" placeholder="Osudy dobrého vojáka Švejka... II" style="width: 300px; margin-bottom: 3px; width: 15rem;"><br>
      ...
      <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["svejk1"])) {
              require "php/svejk1_slovnidruhy.php";
            }   
            if(!empty($_POST["svejk2"])) {
              require "php/svejk2_slovnidruhy.php";
            }         
          }
        ?>
      </div>
