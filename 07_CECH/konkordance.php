...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/07_CECH/konkordance.php">
...
<main>
  <div class="container py-4">   
    ...
    <div style="float: left; margin-left: 6rem; margin-top: -4.5rem; width: 100%;">

    <?php
        if(isset($_POST["submit"])) {
            if(!empty($_POST["broucek15"])) {
              require "php/broucek15_konkordance.php";
              
            }
            if(!empty($_POST["broucekmesic"])) {
              require "php/broucekmesic_konkordance.php";
