...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/07_CECH/asociacni_miry.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="asociacni_miry.php" method="post" style="float: left;">
      <input type="text" name="broucek15" placeholder="Nový epochální výlet pana Broučka..." style="margin-bottom: 7px; width: 300px;"><br>
      <input type="text" name="broucekmesic" placeholder="Pravý výlet pana Broučka do Měsíce" style="margin-bottom: 7px; width: 300px;"><br>
      ...
      <?php
          if(isset($_POST["Submit"])) {
            if(!empty($_POST["broucek15"])) {
              require "php/broucek15_kolokace.php";
          }
          if(!empty($_POST["broucekmesic"])) {
            require "php/broucekmesic_kolokace.php";  
        }
      }
      ?>
    <div>
