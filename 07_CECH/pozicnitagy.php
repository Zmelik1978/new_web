...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/07_CECH/pozicnitagy.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="pozicnitagy.php" method="post" style="float: left; height: 100px; margin-right: 30px; margin-top: 20px;">
        <input type="text" name="broucek15" placeholder="Nový epochální výlet pana Broučka, tentokráte do XV. století" style="width:400px; margin-bottom: 3px;"><br>
        <input type="text" name="broucekmesic" placeholder="Pravý výlet pana Broučka do Měsíce" style="width: 400px; margin-bottom: 3px;"><br>
      ...
      <div style="float: left; margin-top: 20px; width: 400px;">
            <?php
                require "php/boucek15completmorphotags.php";
                require "php/boucekmesiccompletmorphotags.php";
            ?>
      </div>
    </div>
