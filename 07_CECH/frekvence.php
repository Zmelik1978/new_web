...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/07_CECH/frekvence.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="frekvence.php" method="post" style="float: left; margin-right: 50px;">
        <input type="text" name="broucek15" placeholder="Nový epochální výlet pana Broučka..." style="margin-bottom: 5px; width: 300px;"><br>
        <input type="text" name="broucekmesic" placeholder="Pravý výlet pana Broučka do Měsíce" style="margin-bottom: 5px; width: 300px;"><br>
        ...
        <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["broucek15"])) {
              require "php/broucek15_frekvence.php";
            }
            if(!empty($_POST["broucekmesic"])) {
              require "php/broucekmesic_frekvence.php";
          }
        }
        ?>
      </div>
