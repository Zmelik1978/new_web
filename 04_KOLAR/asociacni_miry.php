...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/04_KOLAR/asociacni_miry.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="asociacni_miry.php" method="post" style="float: left;">
      <input type="text" name="peklazplozenci" placeholder="Pekla zplozenci" style="margin-bottom: 7px; width: 19rem;"><br>
      ...
      <?php
          if(isset($_POST["Submit"])) {
            if(!empty($_POST["peklazplozenci"])) {
              require "php/peklazplozenci_kolokace.php";
          }
        }
      ?>
    <div>
