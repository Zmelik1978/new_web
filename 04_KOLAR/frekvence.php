...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/04_KOLAR/frekvence.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="frekvence.php" method="post" style="float: left; margin-right: 50px;">
        <input type="text" name="peklazplozenci" placeholder="Pekla zplozenci" style="margin-bottom: 5px; width: 19rem;"><br>
        ...
        <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["peklazplozenci"])) {
              require "php/peklazplozenci_frekvence.php";
            }
          }
        ?>
      </div>
