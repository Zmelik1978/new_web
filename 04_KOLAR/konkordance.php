...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/04_KOLAR/konkordance.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="konkordance.php" method="post" style="float: left;">
        <input type="text" name="peklazplozenci" placeholder="Peklazplozenci" style="margin-bottom: 7px;"><br>
    ...
    <?php
        if(isset($_POST["submit"])) {
            if(!empty($_POST["peklazplozenci"])) {
              require "php/peklazplozenci_konkordance.php";
