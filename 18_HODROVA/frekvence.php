...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/18_HODROVA/frekvence.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="frekvence.php" method="post" style="float: left; margin-right: 50px;">
        <input type="text" name="podoboji" placeholder="Podobojí" style="margin-bottom: 5px;"><br>
        <input type="text" name="kukly" placeholder="Kukly" style="margin-bottom: 5px;"><br>
        <input type="text" name="theta" placeholder="Théta" style="margin-bottom: 5px;"><br>
        <input type="text" name="mestovidim" placeholder="Město vidím" style="margin-bottom: 5px;"><br>
        <input type="text" name="tocitevety" placeholder="Točité věty" style="margin-bottom: 5px;"><br>
        <input type="text" name="perunuvden" placeholder="Perunův den" style="margin-bottom: 5px;"><br>
        ...
        <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["podoboji"])) {
              require "php/podoboji_frekvence.php";
            }
            if(!empty($_POST["kukly"])) {
              require "php/kukly_frekvence.php";
            }
            if(!empty($_POST["theta"])) {
              require "php/theta_frekvence.php";
            }
            if(!empty($_POST["mestovidim"])) {
              require "php/mestovidim_frekvence.php";
            }
            if(!empty($_POST["tocitevety"])) {
              require "php/tocitevety_frekvence.php";
            }
            if(!empty($_POST["perunuvden"])) {
              require "php/perunuvden_frekvence.php";
            }
          }
        ?>
      </div>
