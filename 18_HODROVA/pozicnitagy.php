...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/18_HODROVA/pozicnitagy.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="pozicnitagy.php" method="post" style="float: left; height: 100px; margin-right: 30px; margin-top: 20px;">
        <input type="text" name="podoboji" placeholder="Podobojí" style="width: 200px; margin-bottom: 3px;"><br>
        <input type="text" name="kukly" placeholder="Kukly" style="width: 200px; margin-bottom: 3px;"><br>
        <input type="text" name="theta" placeholder="Théta" style="width: 200px; margin-bottom: 3px;"><br>
        <input type="text" name="mestovidim" placeholder="Město vidím" style="width: 200px; margin-bottom: 3px;"><br>
        <input type="text" name="tocitevety" placeholder="Točité věty" style="width: 200px; margin-bottom: 3px;"><br>
        <input type="text" name="perunuvden" placeholder="Perunův den" style="width: 200px; margin-bottom: 3px;"><br>
      ...
      <div style="float: left; margin-top: 20px; width: 400px;">
            <?php
                require "php/podobojicompletmorphotags.php";
                require "php/kuklycompletmorphotags.php";
                require "php/thetacompletmorphotags.php";
                require "php/mestovidimcompletmorphotags.php";
                require "php/tocitevetycompletmorphotags.php";
                require "php/perunuvdencompletmorphotags.php";
            ?>
      </div>
    </div>
