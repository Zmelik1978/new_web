...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/18_HODROVA/konkordance.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="konkordance.php" method="post" style="float: left;">
      ...
      <input type="text" name="kukly" placeholder="Kukly" style="margin-bottom: 7px;"><br>
    ...
    <?php
        if(isset($_POST["submit"])) {
            if(!empty($_POST["podoboji"])) {
              require "php/podoboji_konkordance.php";
              
            }
            if(!empty($_POST["kukly"])) {
              require "php/kukly_konkordance.php";
              
            }
            if(!empty($_POST["theta"])) {
              require "php/theta_konkordance.php";
             
            }
            if(!empty($_POST["mestovidim"])) {
              require "php/mestovidim_konkordance.php";
             
            }
            if(!empty($_POST["tocitevety"])) {
              require "php/tocitevety_konkordance.php";
              
            }
            if(!empty($_POST["perunuvden"])) {
              require "php/perunuvden_konkordance.php";
