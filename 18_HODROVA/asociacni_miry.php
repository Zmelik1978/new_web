...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/18_HODROVA/asociacni_miry.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="asociacni_miry.php" method="post" style="float: left;">
      <input type="text" name="podoboji" placeholder="Podobojí" style="margin-bottom: 7px;"><br>
      <input type="text" name="kukly" placeholder="Kulky" style="margin-bottom: 7px;"><br>
      <input type="text" name="theta" placeholder="Théta" style="margin-bottom: 7px;"><br>
      <input type="text" name="mestovidim" placeholder="Město vidím" style="margin-bottom: 7px;"><br>
      <input type="text" name="tocitevety" placeholder="Točité věty" style="margin-bottom: 7px;"><br>
      <input type="text" name="perunuvden" placeholder="Perunův den" style="margin-bottom: 7px;"><br>
      ...
      <?php
          if(isset($_POST["Submit"])) {
            if(!empty($_POST["podoboji"])) {
              require "php/podoboji_kolokace.php";
          }
          if(!empty($_POST["kukly"])) {
            require "php/kukly_kolokace.php";
          }
          if(!empty($_POST["theta"])) {
            require "php/theta_kolokace.php";
          }
          if(!empty($_POST["mestovidim"])) {
            require "php/mestovidim_kolokace.php";
          }
          if(!empty($_POST["tocitevety"])) {
            require "php/tocitevety_kolokace.php";
          }
          if(!empty($_POST["perunuvden"])) {
            require "php/perunuvden_kolokace.php";
          }
        }
      ?>
    <div>
