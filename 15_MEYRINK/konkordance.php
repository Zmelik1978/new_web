...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/15_MEYRINK/konkordance.php">
...
<main>
  <div class="container py-4">   
    ...
    <div style="float: left; margin-left: 2rem; margin-top: -16rem; width: 100%;">

    <?php
        if(isset($_POST["submit"])) {
            if(!empty($_POST["golem"])) {
              require "php/golem_konkordance.php";
              
            }
            if(!empty($_POST["neviditelnapraha"])) {
              require "php/neviditelnapraha_konkordance.php";
              
            }
            if(!empty($_POST["valpurzinanoc"])) {
              require "php/valpurzinanoc_konkordance.php";
             
            }
            if(!empty($_POST["bilydominikan"])) {
              require "php/bilydominikan_konkordance.php";
             
            }
            if(!empty($_POST["prazskavizitka"])) {
              require "php/prazskavizitka_konkordance.php";
              
            }
            if(!empty($_POST["zelenatvar"])) {
              require "php/zelenatvar_konkordance.php";
              
            }
            if(!empty($_POST["andelzapadnihookna"])) {
              require "php/andelzapadnich_okna_konkordance.php";
