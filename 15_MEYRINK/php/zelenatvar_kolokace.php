        ...
        if ($_POST["zelenatvar"]){
            ...
            if (mysqli_num_rows($result_kolokace) > 0){
                while ($radek_kolokace = mysqli_fetch_assoc($result_kolokace)){
                    ...
                    $mysql1 = "SELECT COUNT(word1) as w1 FROM zelenatvarbigramy WHERE word2='".$kolokace."'";
                    mysqli_set_charset($conection, "utf8mb4");
                    ...
                    $mysql2 = "SELECT COUNT(word2) as w2 FROM zelenatvarbigramy WHERE word1='".$lemma."'";
                    mysqli_set_charset($conection, "utf8mb4");
                    ...
                    $mysql3 = "SELECT COUNT(id) as id FROM zelenatvarbigramy WHERE word1='".$lemma."' AND word2='".$kolokace."'";
                    mysqli_set_charset($conection, "utf8mb4");
            ...
            // leve kolokace
            $sql2 = "SELECT DISTINCT LOWER (word1) AS word1 FROM zelenatvarbigramy WHERE word2='".$lemma."'";
            ...
            if (mysqli_num_rows($result_kolokace2) > 0){
                while ($radek_kolokace2 = mysqli_fetch_assoc($result_kolokace2)){
                    ...
                    $mysql4 = "SELECT COUNT(word2) as w2 FROM zelenatvarbigramy WHERE word1='".$kolokace."'";
                    mysqli_set_charset($conection, "utf8mb4");
                    ...
                    $mysql5 = "SELECT COUNT(word1) as w1 FROM zelenatvarbigramy WHERE word2='".$lemma."'";
                    mysqli_set_charset($conection, "utf8mb4");
                    ...
                    $mysql6 = "SELECT COUNT(id) as id FROM zelenatvarbigramy WHERE word2='".$lemma."' AND word1='".$kolokace2."'";
                    mysqli_set_charset($conection, "utf8mb4");
