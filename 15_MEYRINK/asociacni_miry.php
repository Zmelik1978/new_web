...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/15_MEYRINK/asociacni_miry.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="asociacni_miry.php" method="post" style="float: left;">
      <input type="text" name="golem" placeholder="Golem" style="margin-bottom: 7px;"><br>
      <input type="text" name="neviditelnapraha" placeholder="Neviditelná Praha" style="margin-bottom: 7px;"><br>
      <input type="text" name="valpurzinanoc" placeholder="Valpuržina noc" style="margin-bottom: 7px;"><br>
      <input type="text" name="bilydominikan" placeholder="Bílý dominikán" style="margin-bottom: 7px;"><br>
      <input type="text" name="prazskavizitka" placeholder="Pražská vizitka" style="margin-bottom: 7px;"><br>
      <input type="text" name="zelenatvar" placeholder="Zelená tvář" style="margin-bottom: 7px;"><br>
      <input type="text" name="andelzapadnihookna" placeholder="Anděl západního okna" style="margin-bottom: 7px;"><br>
      ...
      <?php
          if(isset($_POST["Submit"])) {
            if(!empty($_POST["golem"])) {
              require "php/golem_kolokace.php";
          }
          if(!empty($_POST["neviditelnapraha"])) {
            require "php/neviditelnapraha_kolokace.php";
          }
          if(!empty($_POST["valpurzinanoc"])) {
            require "php/valpurzinanoc_kolokace.php";
          }
          if(!empty($_POST["bilydominikan"])) {
            require "php/bilydominikan_kolokace.php";
          }
          if(!empty($_POST["prazskavizitka"])) {
            require "php/prazskavizitka_kolokace.php";
          }
          if(!empty($_POST["zelenatvar"])) {
            require "php/zelenatvar_kolokace.php";
          }
          if(!empty($_POST["andelzapadnihookna"])) {
            require "php/andelzapadnihookna_kolokace.php";
          }
        }
      ?>
    <div>
