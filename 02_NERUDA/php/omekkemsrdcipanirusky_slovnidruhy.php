...
// Vo mekkem srdci pani rusky
if (isset($_POST["submit"])) {
    if ($name = $_POST["omekkemsrdcipanirusky"]){
        $conection = mysqli_connect("127.0.0.1", "korpusprozyco001", "prasmoid", "korpusprozycom01");
        mysqli_set_charset($conection, "utf8mb4");

        $stmt = $conection->prepare("SELECT lemma, af, rf FROM omekkemsrdcipaniruskytags WHERE tagy=? LIMIT ?");
