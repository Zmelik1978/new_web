...
if(isset($_POST["submit"])){
    ...
    if($conect){
        $question = "SELECT DISTINCT LOWER (token) AS token FROM utrililiikonkordance WHERE lemma='".$lemma."'";
        ...
        if (mysqli_num_rows($query1) > 0){
            ...
            while($radek1 = mysqli_fetch_assoc($query1)){
                ...
                echo "<a href='frequency-list/utrililii.pdf' target='_blank'><img src='../../icons/file-earmark-pdf.svg' style='width: 20px; height: 20px; margin-left: 20px;'></a>";
            }
        } else {
            echo "<br><br>";
