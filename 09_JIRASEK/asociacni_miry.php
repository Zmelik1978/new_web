...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/09_JIRASEK/asociacni_miry.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="asociacni_miry.php" method="post" style="float: left;">
      <input type="text" name="flvek1" placeholder="F. L. Věk I" style="margin-bottom: 7px;"><br>
      <input type="text" name="flvek2" placeholder="F. L. Věk II" style="margin-bottom: 7px;"><br>
      <input type="text" name="flvek3" placeholder="F. L. Věk III" style="margin-bottom: 7px;"><br>
      <input type="text" name="flvek4" placeholder="F. L. Věk IV" style="margin-bottom: 7px;"><br>
      <input type="text" name="flvek5" placeholder="F. L. Věk V" style="margin-bottom: 7px;"><br>
      <input type="text" name="filozofskahistorie" placeholder="Filozofská historie" style="margin-bottom: 7px;"><br>
      <input type="text" name="temno" placeholder="Temno" style="margin-bottom: 7px;"><br>
      <input type="text" name="psohlavci" placeholder="Psohlavci" style="margin-bottom: 7px;"><br>
      ...
      <?php
          if(isset($_POST["Submit"])) {
            if(!empty($_POST["flvek1"])) {
              require "php/flvek1_kolokace.php";
          }
          if(!empty($_POST["flvek2"])) {
            require "php/flvek2_kolokace.php";
          }
          if(!empty($_POST["flvek3"])) {
            require "php/flvek3_kolokace.php";
          }
          if(!empty($_POST["flvek4"])) {
            require "php/flvek4_kolokace.php";
          }
          if(!empty($_POST["flvek5"])) {
            require "php/flvek5_kolokace.php";
          }
          if(!empty($_POST["filozofskahistorie"])) {
            require "php/filozofskahistorie_kolokace.php";
          } 
          if(!empty($_POST["temno"])) {
            require "php/temno_kolokace.php";
          }
          if(!empty($_POST["psohlavci"])) {
            require "php/psohlavci_kolokace.php";
        }
      }
      ?>
    <div>
