...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/09_JIRASEK/konkordance.php">
...
<main>
  <div class="container py-4">   
    ...
    <div style="float: left; margin-left: 2rem; margin-top: -18.5rem; width: 100%;">

    <?php
        if(isset($_POST["submit"])) {
            if(!empty($_POST["flvek1"])) {
              require "php/flvek1_konkordance.php";
              
            }
            if(!empty($_POST["flvek2"])) {
              require "php/flvek2_konkordance.php";
              
            }
            if(!empty($_POST["flvek3"])) {
              require "php/flvek3_konkordance.php";
              
            }
            if(!empty($_POST["flvek4"])) {
              require "php/flvek4_konkordance.php";
              
            }
            if(!empty($_POST["flvek5"])) {
              require "php/flvek5_konkordance.php";
              
            }
            if(!empty($_POST["filozofskahistorie"])) {
              require "php/filozofskahistorie_konkordance.php";
              
            }
            if(!empty($_POST["temno"])) {
              require "php/temno_konkordance.php";
              
            }
            if(!empty($_POST["psohlavci"])) {
              require "php/psohlavci_konkordance.php";
