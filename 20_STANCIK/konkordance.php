...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/20_STANCIK/konkordance.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="konkordance.php" method="post" style="float: left;">
      <input type="text" name="mlynnamumie" placeholder="Mlýn na mumie" style="margin-bottom: 7px; width: 15rem;"><br>
      <input type="text" name="perak" placeholder="Pérák" style="margin-bottom: 7px; width: 15rem;"><br>
    ...
    <div style="float: left; margin-left: 2rem; margin-top: -5rem; width: 100%;">

    <?php
        if(isset($_POST["submit"])) {
            if(!empty($_POST["mlynnamumie"])) {
              require "php/mlynnamumie_konkordance.php";
              
            }
            if(!empty($_POST["perak"])) {
              require "php/perak_konkordance.php";
