...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/20_STANCIK/asociacni_miry.php">
...
<main>
  <div class="container py-4">   
    ...
    <form action="asociacni_miry.php" method="post" style="float: left;">
      <input type="text" name="mlynnamumie" placeholder="Mlýn na mumie" style="margin-bottom: 7px; width: 19rem;"><br>
      <input type="text" name="perak" placeholder="Pérák" style="margin-bottom: 7px; width: 19rem;"><br>
      ...
      <?php
          if(isset($_POST["Submit"])) {
            if(!empty($_POST["mlynnamumie"])) {
              require "php/mlynnamumie_kolokace.php";
          }
          if(!empty($_POST["perak"])) {
            require "php/perak_kolokace.php";
          }
        }
      ?>
    <div>
