...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/20_STANCIK/frekvence.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="frekvence.php" method="post" style="float: left; margin-right: 50px;">
        <input type="text" name="mlynnamumie" placeholder="Mlýn na mumie" style="margin-bottom: 5px; width: 19rem;"><br>
        <input type="text" name="perak" placeholder="Pérák" style="margin-bottom: 5px; width: 19rem;"><br>
        ...
        <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["mlynnamumie"])) {
              require "php/mlynnamumie_frekvence.php";
            }
            if(!empty($_POST["perak"])) {
              require "php/perak_frekvence.php";
            }
          }
        ?>
      </div>
