...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://korpusprozy.com/08_WINTER/frekvence.php">
  ...
  <div class="container py-4">   
    ...
    <div id="lemmas" class="tabcontent">
      <form action="frekvence.php" method="post" style="float: left; margin-right: 50px;">
        <input type="text" name="mistrkampanus" placeholder="Mistr Kampanus" style="margin-bottom: 5px;"><br>
        ...
        <?php
          if(isset($_POST["submit"])) {
            if(!empty($_POST["mistrkampanus"])) {
              require "php/mistrkampanus_frekvence.php";
            }
          }
        ?>
      </div>
