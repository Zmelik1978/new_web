<?php
// Výpisy dle zadaných tagů: Zázračná madona
if (isset($_POST["submit"])) {
    if ($name = $_POST["madona"]){
        $name;
        $conection = mysqli_connect("127.0.0.1", "korpusprozyco001", "prasmoid", "korpusprozycom01");
        mysqli_set_charset($conection, "utf8mb4");
        switch($name){
            case "N":
                $vyber= "SELECT lemma, af, rf FROM madonatags WHERE tagy='N' LIMIT $radek";
                ...
                break;
            case "A":
                $vyber= "SELECT lemma, af, rf FROM madonatags WHERE tagy='A' LIMIT $radek";
                $result = mysqli_query($conection, $vyber);
                if (mysqli_num_rows($result) > 0){
                    echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>LEMMA</div>";
                    echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>AF</div>";
                ...
                break;
                case "P":
                    $vyber= "SELECT lemma, af, rf FROM madonatags WHERE tagy='P' LIMIT $radek";
                    $result = mysqli_query($conection, $vyber);
                    if (mysqli_num_rows($result) > 0){
                        echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>LEMMA</div>";
                        echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>AF</div>";
                    ...
                    break;
                    case "C":
                        $vyber= "SELECT lemma, af, rf FROM madonatags WHERE tagy='C' LIMIT $radek";
                        $result = mysqli_query($conection, $vyber);
                        if (mysqli_num_rows($result) > 0){
                            echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>LEMMA</div>";
                            echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>AF</div>";
                        ...
                        break;
                        case "V":
                            $vyber= "SELECT lemma, af, rf FROM madonatags WHERE tagy='V' LIMIT $radek";
                            $result = mysqli_query($conection, $vyber);
                            if (mysqli_num_rows($result) > 0){
                                echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>LEMMA</div>";
                                echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>AF</div>";
                            ...
                            break;
                            case "D":
                                $vyber= "SELECT lemma, af, rf FROM madonatags WHERE tagy='D' LIMIT $radek";
                                $result = mysqli_query($conection, $vyber);
                                if (mysqli_num_rows($result) > 0){
                                    echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>LEMMA</div>";
                                    echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>AF</div>";
                                ...
                                break;
                                case "R":
                                    $vyber= "SELECT lemma, af, rf FROM madonatags WHERE tagy='R' LIMIT $radek";
                                    $result = mysqli_query($conection, $vyber);
                                    if (mysqli_num_rows($result) > 0){
                                        echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>LEMMA</div>";
                                        echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>AF</div>";
                                    ...
                                    break;
                                    case "J":
                                        $vyber= "SELECT lemma, af, rf FROM madonatags WHERE tagy='J' LIMIT $radek";
                                        $result = mysqli_query($conection, $vyber);
                                        if (mysqli_num_rows($result) > 0){
                                            echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>LEMMA</div>";
                                            echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>AF</div>";
                                        ...
                                        break;
                                        case "T":
                                            $vyber= "SELECT lemma, af, rf FROM madonatags WHERE tagy='T' LIMIT $radek";
                                            $result = mysqli_query($conection, $vyber);
                                            if (mysqli_num_rows($result) > 0){
                                                echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>LEMMA</div>";
                                                echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>AF</div>";
                                            ...
                                            break;
                                            case "I":
                                                $vyber= "SELECT lemma, af, rf FROM madonatags WHERE tagy='I' LIMIT $radek";
                                                $result = mysqli_query($conection, $vyber);
                                                if (mysqli_num_rows($result) > 0){
                                                    echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>LEMMA</div>";
                                                    echo "<div style='border: 1px solid black; width: 100px; margin-right: 3px; float: left; margin-bottom: 3px; font-weight: bold; background-color: #FFF176;'>AF</div>";
